...
<aside class="right-side">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{ isset($asset) ? Lang::get('core::core.editing', ['model' => Lang::get('asset::asset.singular'), 'name' => $asset->title]) : Lang::get('core::core.create') .' '. Lang::get('asset::asset.singular') }}</li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs pull-right">
            ...
            <li><a href="#file" data-toggle="tab">{{ Lang::get('asset::asset.plural')}}</a></li>
            ...
            <li class="pull-left header"><i class="fa fa-paperclip"></i> {{ isset($asset) ? Lang::get('core::core.editing', ['model' => Lang::get('asset::asset.singular'), 'name' => $asset->title]) : Lang::get('core::core.create') .' '. Lang::get('asset::asset.singular') }}</li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                @if (isset($asset))
                <li role="presentation"><a href="{{ route('page.show', [$asset->slug]) }}" target="_blank" role="menuitem" tabindex="-1" href="#"><i class="fa fa-eye"></i> {{ Lang::get('core::core.preview')}}</a></li>
                @endif
